...
def main(name, argv):
        ...
        with open('reslist', 'w') as dirf:
                for line in reslist:
                        dirf.write(line + '\n')
        results_jobs = cluster.runBatchJobs('reslist', os.environ["COVALENTIZER"] + 'Scripts/Covalentizer/Final_Scripts/combine_cluster.sh', mem='32000mb')
